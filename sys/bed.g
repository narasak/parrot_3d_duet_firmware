...
while iterations <=2                                   ; perform 3 passes
   G30 P0 X10 Y105 Z-99999                               ; probe near a leadscrew, half way along Y axis
   G30 P1 X225 Y105 Z-99999 S2                           ; probe near a leadscrew and calibrate 2 motors
   G1 X148.5 F10000                                      ; move to the center of the bed
...
while move.calibration.initial.deviation >= 0.35       ; perform additional leveling if previous deviation was over 0.003mm
   if iterations = 5                                   ; perform 5 addition checks, if needed
      ...
      G30 P0 X10 Y105 Z-99999                            ; probe near a leadscrew, half way along Y axis
      G30 P1 X225 Y105 Z-99999 S2                        ; probe near a leadscrew and calibrate 2 motors
   G1 X148.5 F10000                                      ; move the nozzle to the center of the bed
   G30                                                 ; probe the bed at the current XY position
   M400                                                ; finish all moves, clear the buffer
;
